# Generated by Powerlevel10k configuration wizard on 2022-02-22 at 00:36 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # scalaen               # scala version from scalaenv (https://github.com/scalaenv/scalaenv)
    # haskl_stack           # haskell version from stack (https://haskellstack.org/)
